...
// funcao principal
NO *caminho(int N, BOOL A, int *ijpeso, int *aberto, int inicio, int fim, int chave);
...
int main() {
	...
	int N=3; // grafo de 3 vertices numerados de 1..3
	...
	NO* teste = NULL;
	teste = caminho(N, true, ijpeso, aberto, inicio, fim, chave);
	return teste;
